...
function SitemapLinks({ children }: { children: React.ReactNode }) {
  return <ul className="mt-6 space-y-4 text-xs/6">{children}</ul>
}
    ...
    <>
      ...
      <div>
        ...
        <SitemapLinks>
          ...
          <SitemapLink href="/company">About Consult Net Zero</SitemapLink>
        </SitemapLinks>
      </div>
      <div>
        <SitemapHeading>Support</SitemapHeading>
        <SitemapLinks>
          <SitemapLink href="#">Frequently Asked Questions</SitemapLink>
...
function Copyright() {
  return (
    <div className="text-sm/6 text-gray-950">
      &copy; {new Date().getFullYear()} Consult Net Zero.
    </div>
  )
}
