...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Companies all over the world have closed millions of deals with Consult Net Zero. Sign up today and start selling smarter.',
}
...
const tiers = [
  {
    ...
    highlights: [
      ...
      { description: 'Consult Net Zero integrations', disabled: true },
  ...
  },
  {
    ...
    highlights: [
      ...
      { description: 'Consult Net Zero integrations', disabled: false },
  ...
  return (
    <Container className="mt-16">
      ...
      <Lead className="mt-6 max-w-3xl">
        Companies all over the world have closed millions of deals with Consult Net Zero.
...
function PricingCards() {
  return (
    <div className="relative py-24">
      <Gradient className="absolute inset-x-2 bottom-0 top-48 rounded-lg ring-1 ring-inset ring-black/5" />
...
function PricingCard({ tier }: { tier: (typeof tiers)[number] }) {
  return (
    <div className="-m-2 grid grid-cols-1  shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
      <div className="grid grid-cols-1 rounded-lg p-2 shadow-md shadow-black/5">
...
function Testimonial() {
  return (
    <div className="mx-2 my-24 rounded-lg bg-gray-900 bg-[url(/dot-texture.svg)] pb-24 pt-72 lg:pt-36">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-[384px_1fr_1fr]">
          <div className="-mt-96 lg:-mt-52">
            <div className="-m-2 rounded-lg bg-white/15 shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:max-w-xs">
              <div className="rounded-lg p-2 shadow-md shadow-black/5">
            ...
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”'] lg:text-4xl">
                  Thanks to Consult Net Zero, we&apos;re finding new leads that we never
